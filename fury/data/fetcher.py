...
FURY_DATA_URL = "https://raw.githubusercontent.com/fury-gl/fury-data/master/examples/"

MODEL_DATA_URL = "https://raw.githubusercontent.com/fury-gl/fury-data/master/models/"

TEXTURE_DATA_URL = (
    "https://raw.githubusercontent.com/fury-gl/fury-data/master/textures/"
)

DMRI_DATA_URL = "https://raw.githubusercontent.com/fury-gl/fury-data/master/dmri/"
...
async def _fetch_gltf(name, mode):
    ...
    if isinstance(name, list):
        ...
        if urls is None:
            raise ValueError("Model name and mode combination doesn't exist")
